...
* If necessary, you can use the space before identifying the next state (always with the format <state> STATE NAME </state>) to think about your current task. But remember that if you mention the 'PAUSE' word your turn is over, so put it at the end of your message not between your thoughts
